export const i18nLayout = {
    es: { title: "Mi portfolio" },
    en: { title: "My portfolio" }
}

export const i18nNavbar = {
    es: {
        links: ["experiencia", "proyectos", "tecnologías"]
    },
    en: {
        links: ["experience", "projects", "techs"]
    }
}
...
export const i18nHeader = {
    es: {
        h1: "Hola, soy ",
        h2: "Soy un ",
        h2_title: "desarrollador frontend."
    },
    en: {
        h1: "Hi, I'm ",
        h2: "I'm a ",
        h2_title: "frontend developer."
    }
}
